...
function makeStuModifyBtn() {
    ...
    row += '<div class="col-lg-2"><button type="button" class="btn btn-danger" id="modifyStu"><i class="fa fa-remove fa-fw"></i>Modify</button></div>';
...
function makeTeaModifyBtn() {
    let row = '<div class="col-lg-10"></div>';
    row += '<div class="col-lg-2"><button type="button" class="btn btn-danger" id="modifyTea"><i class="fa fa-remove fa-fw"></i>Modify</button></div>';
...
function makeCrsModifyBtn() {
    let row = '<div class="col-lg-10"></div>';
    row += '<div class="col-lg-2"><button type="button" class="btn btn-danger" id="modifyCrs"><i class="fa fa-remove fa-fw"></i>Modify</button></div>';
